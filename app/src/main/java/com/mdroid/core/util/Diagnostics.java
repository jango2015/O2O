...
public class Diagnostics {
	...
	public static final boolean SUPPORTS_ICS, SUPPORTS_HONEYCOMB,
			SUPPORTS_GINGERBREAD, SUPPORTS_FROYO, SUPPORTS_ECLAIR,
	...
	public static String getAndroidId(Context context) {
		...
		if (androidId == null) {
			...
			androidId = android.provider.Settings.System.getString(
	 ...
	 * @param fallbackValue
	 *            the fallback value
	 * @return the device's ANDROID_ID, or the fallback value if it could not be
	 *         determined
	 * @see Secure#ANDROID_ID
	 */
	...
	public static String createDiagnosis(Activity context, Exception error) {
		...
		sb.append("Application version: "
				+ getApplicationVersionString(context) + "\n");
		...
		sb.append("Android " + Build.VERSION.RELEASE + " " + Build.ID
