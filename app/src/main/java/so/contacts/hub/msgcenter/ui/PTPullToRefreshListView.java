 ...
 * @version 1.3.0
 */
public class PTPullToRefreshListView extends ListView{

    private static final float PULL_RESISTANCE                 = 1.7f;
    private static final int   BOUNCE_ANIMATION_DURATION       = 700;
    private static final int   BOUNCE_ANIMATION_DELAY          = 100;
    private static final float BOUNCE_OVERSHOOT_TENSION        = 1.8f;
    ...
    public PTPullToRefreshListView(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }

    public PTPullToRefreshListView(Context context, AttributeSet attrs, int defStyle){
    ...
    private void init(){
        ...
        headerContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.putao_order_refresh_header, null);
        ...
        pullToRefreshText = getContext().getString(R.string.putao_cinema_pull_to_refresh_pull_label);
        releaseToRefreshText = getContext().getString(R.string.putao_cinema_pull_to_refresh_release_label);
        refreshingText = getContext().getString(R.string.putao_cinema_pull_to_refresh_refreshing_label);
        lastUpdatedText = getContext().getString(R.string.putao_cinema_pull_to_refresh_last_updated);
...
//        bounceAnimation.setInterpolator(new OvershootInterpolator(BOUNCE_OVERSHOOT_TENSION));
        bounceAnimation.setInterpolator(new DecelerateInterpolator(BOUNCE_OVERSHOOT_TENSION));
