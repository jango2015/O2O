...
public class CinemaMovieDetailXMLParser implements CinemaIXMLBaseParser {

    @Override
    public CinemaMovieDetail parse(InputStream is) throws Exception {
        ...
        while(evtType != XmlPullParser.END_DOCUMENT){ 
            ...
            case XmlPullParser.START_TAG:
                ...
                if(startTag.equalsIgnoreCase("movie")) {
