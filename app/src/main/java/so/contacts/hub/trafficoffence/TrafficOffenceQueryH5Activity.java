...
public class TrafficOffenceQueryH5Activity extends YellowPageH5Activity {
	private static final String TAG = TrafficOffenceQueryH5Activity.class.getSimpleName();
...
//			mHandler.sendEmptyMessage(MSG_RECEIVED_ERROR_ACTION);
		...
		public boolean putao_onJsAlert(WebView view, String url,
			...
			final CommonDialog alertDialog = CommonDialogFactory.getOkCancelCommonDialog(TrafficOffenceQueryH5Activity.this);
