...
public class YellowPageTrainTicketOrderHistoryH5Activity extends
		YellowPageH5Activity {
	private static String TAG = "YellowPageTrainTicketOrderHistoryH5Activity";
	...
	protected void configWebSettings() {
		...
		CookieSyncManager.createInstance(YellowPageTrainTicketOrderHistoryH5Activity.this);		
	...
	public class MyPutaoWebClientProxy extends PutaoWebClientProxy {
		...
		public boolean putao_onJsAlert(WebView view, String url,
			...
			final CommonDialog alertDialog = CommonDialogFactory
					.getOkCancelCommonDialog(YellowPageTrainTicketOrderHistoryH5Activity.this);
