 ...
 * 
 */
public final class YellowPageDianpingGroupActivity extends YellowPageH5Activity implements OnClickListener,
        LBSServiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobclickAgentUtil.onEvent(this, UMengEventIds.DISCOVER_YELLOWPAGE_MY_ORDER_TUANGOU);
    ...
    protected void configWebSettings() {
		...
		CookieSyncManager.createInstance(YellowPageDianpingGroupActivity.this);		
...
//            mHandler.sendEmptyMessage(MSG_RECEIVED_ERROR_ACTION);
            ...
            LogUtil.e(TAG, "putao_onReceivedError errorCode=" + errorCode + " description= " + description + " failingUrl=" + failingUrl);
        }
    ...
    public void onLocationFailed() {
        ...
        //modify by lisheng 2014-11-19 11:46:35
        loadUrl(mUrl);
        //modify by lisheng
    }
