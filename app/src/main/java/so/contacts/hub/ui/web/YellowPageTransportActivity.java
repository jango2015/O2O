...
//对应功能 "客运"
/**
 * 和 YellowPageDetailActivity 的区别只在于 改变了关闭进度条的方式
 * @author Administrator
 *
 */
public final class YellowPageTransportActivity extends YellowPageDetailActivity{
    private static final String TAG = YellowPageTransportActivity.class.getSimpleName();
    
    @Override
    protected void onCreate(Bundle savedInstanceState) {
    	// TODO Auto-generated method stub
    	super.onCreate(savedInstanceState);
    	MobclickAgentUtil.onEvent(this, UMengEventIds.DISCOVER_YELLOWPAGE_DRIVER_TRANSPORT);
    }
...
//          mHandler.sendEmptyMessage(MSG_RECEIVED_ERROR_ACTION);
        ...
        public boolean putao_onJsAlert(WebView view, String url,
            ...
            final CommonDialog alertDialog = CommonDialogFactory.getOkCancelCommonDialog(YellowPageTransportActivity.this);
