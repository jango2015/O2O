...
public class TrafficPaymentUIFactory implements PaymentResultUIFactory {
    ...
    public PaymentResultUI createUI() {
        ...
        result.setTitle(R.string.putao_charge_tag_title_tiffic, null);
...
//        result.setQuestionActivityClass(ChargeQuestionActivity.class);
        ...
        result.addDynamicRow(R.string.putao_charge_traffic_hint,-1, "traffic_value");
    ...
    protected SparseArray<PaymentResultHintUI> createWeChatHint() {
        ...
        desc.hintTxt.valueResId = R.string.putao_charge_traffic_tips_for_success;
        result.put(ResultCode.OrderStatus.Success, desc);

        desc = new PaymentResultHintUI();
        desc.infoTxt.valueResId = R.string.putao_charge_deal_success;
        desc.hintTxt.valueResId = R.string.putao_charge_traffic_tips_for_pending;
        desc.iconId = successIcon;
