...
public abstract class YellowPageIndicatorFragmentActivity extends BaseRemindFragmentActivity implements OnPageChangeListener,OnClickListener {
    ...
    private final void initViews() {
        ...
        View backView =  findViewById(R.id.back_layout);
        if(backView != null){
